...
@Component
public class PagamentoCartaoDebitoImpl  implements PagamentoStrategy {
    ...
    public void pagar(Pagamento pagamento) {
        try {
            ...
            logger.error("Pagamento por Cartão de Debito salvo com sucesso :)");
        }catch (Exception e){
            logger.error("Erro ao processar pagamento por Cartão de Debito. Erro: {}", e.getMessage());
            throw e;
        }
    }
    ...
    public OperacaoEnum getOperacao() {
        return OperacaoEnum.CARTAO_DEBITO;
    }
}
